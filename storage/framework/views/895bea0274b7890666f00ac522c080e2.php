...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p><strong>Bonjour <?php echo e($client_name ?? 'Client'); ?> !</strong></p>

            <p>Nous vous remercions sincèrement pour votre suggestion concernant nos services.</p>

            <div class="info-card">
                <div style="text-align: left;">
                    <p><strong>Référence:</strong> <?php echo e($feedback_reference ?? 'N/A'); ?></p>
                    <p><strong>Votre note:</strong> <?php echo e($rating ?? 'N/A'); ?>/5 ⭐</p>
                    <p><strong>Date:</strong> <?php echo e($created_at ?? now()->format('d/m/Y à H:i')); ?></p>
            ...
            <p style="color: #666; margin-top: 30px;">
                Cordialement,<br>
                L'équipe <?php echo e($company_name ?? 'QualyWatch'); ?>

            </p>
        </div>
    </div>
</body>
</html><?php /**PATH C:\Projet\qualywatch\backend\resources\views/emails/suggestion-merci.blade.php ENDPATH**/ ?>