...
<body>
    ...
    <div class="full-width-header">
        <div class="header-container" style="text-align: center; padding: 0; background: linear-gradient(135deg, #EA580C 0%, #FB923C 100%); width: 100%; border-radius: 20px 20px 0 0;">
            ...
            <h1 style="margin: 0; padding: 30px; font-size: 28px; font-weight: bold; color: white; text-shadow: 0 2px 4px rgba(0,0,0,0.2); text-align: center; width: 100%; display: block;">Qualy<?php echo e($company_name ?? ''); ?></h1>
    ...
    <div class="email-container">
        ...
        <div class="footer">
            ...
            <div style="text-align: center; margin-bottom: 15px;">
                <img src="<?php echo e(asset('images/qualywatch-logo.png')); ?>" alt="Qualy<?php echo e($company_name ?? ''); ?>" style="max-width: 120px; height: auto; opacity: 0.8;">
            </div>
