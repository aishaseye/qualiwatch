...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p><strong>Bonjour {{ $client_name }} !</strong></p>

            <p>Nous vous remercions sincèrement pour votre suggestion concernant nos services.</p>

            <div class="info-box">
                <p><strong>Référence:</strong> {{ $feedback_reference }}</p>
                <p><strong>Votre note:</strong> {{ $rating }}/5 ⭐</p>
            ...
            <div style="background: linear-gradient(135deg, #DBEAFE 0%, #BFDBFE 100%); padding: 25px; border-radius: 8px; text-align: center; margin: 25px 0;">
                ...
                <p style="margin-bottom: 0; color: #1E3A8A;">
                    ...
                    Notre équipe va étudier attentivement votre proposition. mouhamed.konate@mirahtec.com
                </p>
            </div>
